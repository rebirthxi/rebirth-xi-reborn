    ...
    [xi.regime.type.FIELDS] =
    {
        ...
        zone =
        {
            [xi.zone.WEST_RONFAURE] =
            {
                ...
                page =
                {
                    { 6,0,0,0, 1, 6, 270,  1, {{ chance = 100, item = 12440}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Leather Bandana
                    { 6,0,0,0, 2, 6, 285,  2, {{ chance = 100, item = 12568}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Leather Vest
                    { 5,1,0,0, 4, 7, 300,  3, {{ chance = 100, item = 12696}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Leather Gloves
                    { 4,2,0,0, 4, 8, 315,  4, {{ chance = 100, item = 12824}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Leather Trousers
                    { 6,1,0,0, 4, 8, 330, 56, {{ chance = 100, item = 12952}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Leather HighBoots
                },
            },
            [xi.zone.EAST_RONFAURE] =
            {
                ...
                page =
                {
                    { 6,0,0,0, 1, 5, 270, 64, {{ chance = 100, item = 12440}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Leather Bandana
                    { 6,0,0,0, 2, 5, 285, 65, {{ chance = 100, item = 12568}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Leather Vest
                    { 7,0,0,0, 2, 6, 300, 66, {{ chance = 100, item = 12696}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Leather Gloves
                    { 4,2,0,0, 3, 6, 315, 67, {{ chance = 100, item = 12824}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Leather Trousers
                    { 4,2,0,0, 4, 8, 330, 68, {{ chance = 100, item = 12952}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Leather HighBoots
                },
            },
            [xi.zone.LA_THEINE_PLATEAU] =
            {
                ...
                page =
                {
                    { 3,3,0,0, 8,12, 330,  5, {{ chance = 66, item = 12441}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Lizard Helm
                    { 3,5,0,0,11,13, 360, 69, {{ chance = 66, item = 12569}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Lizard Jerkin
                    { 8,0,0,0,12,13, 390,  6, {{ chance = 66, item = 12697}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Lizard Gloves
                    { 5,3,0,0,11,14, 420, 70, {{ chance = 66, item = 12825}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Lizard Trousers
                    { 5,3,0,0,10,15, 450, 71, {{ chance = 66, item = 12953}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Lizard Ledelsens
                },
            },
            [xi.zone.VALKURM_DUNES] =
            {
                ...
                page =
                {
                    { 7,1,0,0,15,19, 475,  7, {{ chance = 10, item = 15161}, { chance = 10, item = 12458},   -- Noct Beret, Soil Hachimaki
                                               ...
                                               {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 65}, pool = {1, 1}}}}}, -- Seer's Crown, Eisenschaller
                    { 6,2,0,0,15,22, 500,  8, {{ chance = 10, item = 14422}, { chance = 10, item = 12586},   -- Noct Doublet, Soil Gi
                                               ...
                                               {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 65}, pool = {1, 1}}}}}, -- Seer's Tunic, Eisenbrust
                    { 5,3,0,0,18,23, 525,  9, {{ chance = 10, item = 14854}, { chance = 10, item = 12714},   -- Noct Gloves, Soil Tekko
                                               ...
                                               {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 65}, pool = {1, 1}}}}}, -- Seer's Mitts, Eisenhentzes
                    { 4,4,0,0,20,23, 550, 10, {{ chance = 10, item = 14323}, { chance = 10, item = 12842},   -- Noct Brais, Soil Sitabaki
                                               ...
                                               {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 65}, pool = {1, 1}}}}}, -- Seer's Slack, Eisendiechlings
                    { 4,2,0,0,22,25, 575, 57, {{ chance = 10, item = 15311}, { chance = 10, item = 12970},   -- Noct Gaiters, Soil Kyahan
                                               ...
                                               {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 65}, pool = {1, 1}}}}}, -- Seer's Pumps, Eisenschuhs
                },
            },
            [xi.zone.JUGNER_FOREST] =
            {
                ...
                page =
                {
                    { 8,2,0,0,15,18, 480, 58, {{ chance = 45, item = 12442}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Studded Bandana
                    { 9,0,0,0,21,22, 540, 11, {{ chance = 45, item = 12570}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Studded Vest
                    { 8,1,0,0,21,23, 570, 12, {{ chance = 45, item = 12698}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Studded Gloves
                    { 7,2,0,0,22,25, 600, 13, {{ chance = 45, item = 12826}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Studded Trousers
                    { 6,3,0,0,24,25, 630, 14, {{ chance = 45, item = 12954}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Studded Boots
                },
            },
            ...
            [xi.zone.NORTH_GUSTABERG] =
            {
                ...
                page =
                {
                    { 6,0,0,0, 1, 6, 270, 16, {{ chance = 100, item = 12449}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Brass Cap
                    { 6,0,0,0, 3, 6, 285, 17, {{ chance = 100, item = 12577}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Brass Harness
                    { 5,1,0,0, 3, 7, 300, 18, {{ chance = 100, item = 12705}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Brass Mittens
                    { 4,2,0,0, 3, 8, 315, 19, {{ chance = 100, item = 12833}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Brass Subligar
                    { 3,4,0,0, 3, 8, 330, 59, {{ chance = 100, item = 12961}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Brass Leggings
                },
            },
            [xi.zone.SOUTH_GUSTABERG] =
            {
                ...
                page =
                {
                    { 6,0,0,0, 1, 6, 270, 76, {{ chance = 100, item = 12449}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Brass Cap
                    { 7,0,0,0, 2, 5, 285, 77, {{ chance = 100, item = 12577}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Brass Harness
                    { 3,3,0,0, 3, 6, 300, 78, {{ chance = 100, item = 12705}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Brass Mittens
                    { 7,0,0,0, 3, 6, 315, 79, {{ chance = 100, item = 12833}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Brass Subligar
                    { 5,2,0,0, 4, 8, 330, 80, {{ chance = 100, item = 12961}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Brass Leggings
                },
            },
            [xi.zone.KONSCHTAT_HIGHLANDS] =
            {
                ...
                page =
                {
                    { 4,2,0,0, 8,11, 340, 81, {{ chance = 66, item = 12455}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Beetle Mask
                    { 4,2,0,0, 9,12, 360, 82, {{ chance = 66, item = 12583}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Beetle Harness
                    { 3,3,0,0,10,12, 330, 20, {{ chance = 66, item = 12711}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Beetle Mittens
                    { 6,0,0,0, 9,15, 380, 83, {{ chance = 66, item = 12835}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Beetle Subligar
                    { 2,2,2,0,12,14, 400, 84, {{ chance = 66, item = 12967}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Beetle Leggings
                },
            },
            [xi.zone.PASHHOW_MARSHLANDS] =
            {
                ...
                page =
                {
                    { 9,0,0,0,20,21, 540, 21, {{ chance = 45, item = 12450}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Padded Cap
                    { 8,1,0,0,20,22, 570, 22, {{ chance = 45, item = 12578}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Padded Armor
                    { 7,2,0,0,21,23, 600, 23, {{ chance = 45, item = 12706}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Iron Mittens
                    { 6,3,0,0,22,25, 630, 24, {{ chance = 45, item = 12836}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Iron Subligar
                    { 5,4,1,0,22,25, 660, 60, {{ chance = 45, item = 12962}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Leggings
                },
            },
            ...
            [xi.zone.WEST_SARUTABARUTA] =
            {
                ...
                page =
                {
                    { 6,0,0,0, 1, 5, 270, 26, {{ chance = 100, item = 12608}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Tunic
                    { 6,0,0,0, 2, 5, 285, 27, {{ chance = 100, item = 12736}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Mitts
                    { 5,1,0,0, 3, 8, 300, 28, {{ chance = 100, item = 12864}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Slacks
                    { 4,2,0,0, 4, 8, 315, 29, {{ chance = 100, item = 12992}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Solea
                    { 4,2,0,0, 4, 8, 330, 61, {{ chance = 100, item = 12608}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Tunic
                },
            },
            [xi.zone.EAST_SARUTABARUTA] =
            {
                ...
                page =
                {
                    { 6,0,0,0, 1, 6, 270, 89, {{ chance = 100, item = 12608}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Tunic
                    { 6,0,0,0, 1, 8, 285, 90, {{ chance = 100, item = 12736}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Mitts
                    { 6,0,0,0, 2, 6, 300, 91, {{ chance = 100, item = 12864}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Slacks
                    { 4,2,0,0, 3, 6, 315, 92, {{ chance = 100, item = 12992}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Solea
                    { 4,3,0,0, 3, 6, 330, 93, {{ chance = 100, item = 12608}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 25}, pool = {1, 1}}}}}, -- Tunic
                },
            },
            [xi.zone.TAHRONGI_CANYON] =
            {
                ...
                page =
                {
                    { 3,3,0,0, 7,12, 330, 30, {{ chance = 66, item = 12473}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Poet's Circlet
                    { 8,0,0,0,11,13, 450, 31, {{ chance = 66, item = 12601}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Linen Robe
                    { 4,2,0,0, 7,11, 315, 94, {{ chance = 66, item = 12729}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Linen Cuffs
                    { 3,3,0,0, 8,12, 370, 95, {{ chance = 66, item = 12857}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Linen Slops
                    { 3,4,0,0,12,16, 475, 96, {{ chance = 66, item = 12985}, {chance = 35, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 50}, pool = {1, 1}}}}}, -- Holly Clogs
                },
            },
            ...
            [xi.zone.MERIPHATAUD_MOUNTAINS] =
            {
                ...
                page =
                {
                    { 9,0,0,0,20,21, 540, 36, {{ chance = 45, item = 12474}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Wool Hat
                    { 8,1,0,0,20,22, 570, 37, {{ chance = 45, item = 12602}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Wool Robe
                    { 7,2,0,0,21,23, 600, 38, {{ chance = 45, item = 12730}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Wool Cuffs
                    { 6,3,0,0,22,25, 630, 39, {{ chance = 45, item = 12858}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Wool Slops
                    { 3,5,0,0,25,27, 660, 63, {{ chance = 45, item = 12858}, {chance = 50, item = xi.augments.ingredients.LOWBIE_AUG, augment = {chances = {100, 75}, pool = {1, 1}}}}}, -- Chestnut Sabots
                },
            },
