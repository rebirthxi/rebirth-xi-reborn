...
{
--                                     1     2           3            4            5           6              7          8
-- Structure:            [spellId] = { Tier, Main_Skill, Main_Effect, Spell_Level, Base_Power, Base_Duration, Composure, Always_Overwrite },

    -- Aquaveil
    [xi.magic.spell.AQUAVEIL     ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.AQUAVEIL,       1,    1,  600, true,  true  },

    -- Bar-Element
    [xi.magic.spell.BARAERO      ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.BARAERO,        1,    0,  480, true,  true  },
    [xi.magic.spell.BARBLIZZARD  ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.BARBLIZZARD,    1,    0,  480, true,  true  },
    [xi.magic.spell.BARFIRE      ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.BARFIRE,        1,    0,  480, true,  true  },
    [xi.magic.spell.BARSTONE     ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.BARSTONE,       1,    0,  480, true,  true  },
    [xi.magic.spell.BARTHUNDER   ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.BARTHUNDER,     1,    0,  480, true,  true  },
    [xi.magic.spell.BARWATER     ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.BARWATER,       1,    0,  480, true,  true  },
    [xi.magic.spell.BARAERA      ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.BARAERO,        1,    0,  480, true,  true  },
    [xi.magic.spell.BARBLIZZARA  ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.BARBLIZZARD,    1,    0,  480, true,  true  },
    [xi.magic.spell.BARFIRA      ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.BARFIRE,        1,    0,  480, true,  true  },
    [xi.magic.spell.BARSTONRA    ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.BARSTONE,       1,    0,  480, true,  true  },
    ...
    [xi.magic.spell.SNEAK        ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.SNEAK,         20,    0,  420, true,  false },

    -- Embrava
    [xi.magic.spell.EMBRAVA      ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.EMBRAVA,        5,    0,   90, true,  true  },

    -- En-Spell
    [xi.magic.spell.ENAERO       ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.ENAERO,        20,    0,  180, true,  false },
    [xi.magic.spell.ENBLIZZARD   ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.ENBLIZZARD,    22,    0,  180, true,  false },
    [xi.magic.spell.ENFIRE       ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.ENFIRE,        24,    0,  180, true,  false },
    [xi.magic.spell.ENSTONE      ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.ENSTONE,       18,    0,  180, true,  false },
    [xi.magic.spell.ENTHUNDER    ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.ENTHUNDER,     16,    0,  180, true,  false },
    [xi.magic.spell.ENWATER      ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.ENWATER,       27,    0,  180, true,  false },

    [xi.magic.spell.ENAERO_II    ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.ENAERO_II,     54,    0,  180, true,  false },
    [xi.magic.spell.ENBLIZZARD_II] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.ENBLIZZARD_II, 56,    0,  180, true,  false },
    [xi.magic.spell.ENFIRE_II    ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.ENFIRE_II,     58,    0,  180, true,  false },
    [xi.magic.spell.ENSTONE_II   ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.ENSTONE_II,    52,    0,  180, true,  false },
    ...
    [xi.magic.spell.HASTE_II     ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.HASTE,         96, 2998,  180, true,  false },
    [xi.magic.spell.HASTEGA      ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.HASTE,         48, 1494,  180, false, false },
    -- [xi.magic.spell.HASTEGA_II   ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.HASTE,         99, 2998,  180, false, false },

    -- Phalanx
    [xi.magic.spell.PHALANX      ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.PHALANX,       33,    0,  180, true,  false },
    [xi.magic.spell.PHALANX_II   ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.PHALANX,       75,    0,  240, true,  false },
    ...
    [xi.magic.spell.PROTECT_IV   ] = { 4, xi.skill.ENHANCING_MAGIC, xi.effect.PROTECT,       63,  140, 1800, false, false },
    [xi.magic.spell.PROTECT_V    ] = { 5, xi.skill.ENHANCING_MAGIC, xi.effect.PROTECT,       76,  220, 1800, false, false },
    [xi.magic.spell.PROTECTRA    ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.PROTECT,        7,   20, 1800, false, false },
    [xi.magic.spell.PROTECTRA_II ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.PROTECT,       27,   50, 1800, false, false },
    [xi.magic.spell.PROTECTRA_III] = { 3, xi.skill.ENHANCING_MAGIC, xi.effect.PROTECT,       47,   90, 1800, false, false },
    [xi.magic.spell.PROTECTRA_IV ] = { 4, xi.skill.ENHANCING_MAGIC, xi.effect.PROTECT,       63,  140, 1800, false, false },
    [xi.magic.spell.PROTECTRA_V  ] = { 5, xi.skill.ENHANCING_MAGIC, xi.effect.PROTECT,       75,  220, 1800, false, false },

    -- Refresh
    [xi.magic.spell.REFRESH      ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.REFRESH,       41,    3,  150, true,  true  },
    [xi.magic.spell.REFRESH_II   ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.REFRESH,       82,    6,  150, true,  true  },
    [xi.magic.spell.REFRESH_III  ] = { 3, xi.skill.ENHANCING_MAGIC, xi.effect.REFRESH,       99,    9,  150, true,  true  },

    -- Regen
    [xi.magic.spell.REGEN        ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.REGEN,         21,    5,   75, true,  false },
    [xi.magic.spell.REGEN_II     ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.REGEN,         44,   12,   60, true,  false },
    [xi.magic.spell.REGEN_III    ] = { 3, xi.skill.ENHANCING_MAGIC, xi.effect.REGEN,         66,   20,   60, true,  false },
    ...
    [xi.magic.spell.SHELL_IV     ] = { 4, xi.skill.ENHANCING_MAGIC, xi.effect.SHELL,         68, 2617, 1800, false, false },
    [xi.magic.spell.SHELL_V      ] = { 5, xi.skill.ENHANCING_MAGIC, xi.effect.SHELL,         76, 2930, 1800, false, false },
    [xi.magic.spell.SHELLRA      ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.SHELL,         18, 1055, 1800, false, false },
    [xi.magic.spell.SHELLRA_II   ] = { 2, xi.skill.ENHANCING_MAGIC, xi.effect.SHELL,         37, 1641, 1800, false, false },
    ...
    -- -Spikes
    [xi.magic.spell.BLAZE_SPIKES ] = { 1, xi.skill.ENHANCING_MAGIC, xi.effect.BLAZE_SPIKES,   1,    0,  180, true,  false },
