...
xi.settings.main =
{
    ...
    SERVER_NAME = "RebirthXI",

    SERVER_MESSAGE =
        "Welcome back once again to RebirthXI Reborn aka QuetzRebirth.\n" ..
        "Please find all relevant information on our Discord: link here\n" ..
        "Thank you!",
    ...
    DIG_ABUNDANCE_BONUS          = 5,    -- Increase chance of digging up an item (450  = item digup chance +45)
    ...
    ENM_COOLDOWN                 = 480,  -- Number of hours before a player can obtain same KI for ENMs (default: 5 days)
