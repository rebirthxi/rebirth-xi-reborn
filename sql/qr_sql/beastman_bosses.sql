-- Level Buff
UPDATE mob_groups SET minLevel=95, maxLevel=95 WHERE name='Za_Dha_Adamantking' and zoneid=148;
UPDATE mob_groups SET minLevel=95, maxLevel=95 WHERE name='Tzee_Xicu_the_Manifest' and zoneid=151;
UPDATE mob_groups SET minLevel=95, maxLevel=95 WHERE name='Overlord_Bakgodek' and zoneid=150;
